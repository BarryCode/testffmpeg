// FFMpegLibTest.cpp : 定义控制台应用程序的入口点。
//
...
const char *filter_descr = "amix=inputs=2";
void getMixAudio();
...
static int init_filters(const char *filters_descr)
{
	...
	sprintf_s(args, sizeof(args), "sample_fmts=s16:sample_rates=%d:channel_layouts=mono",44100);
...
void getMixAudio()
{
	...
	while (1) 
	{
		...
		if(ret >= 0)
		{
            ...
            ret = avcodec_encode_audio2(dec_ctx, &pkt, out_frame_, &got_output);
            if (ret < 0) {
